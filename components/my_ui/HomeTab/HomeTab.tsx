...
useEffect(() => {
  ...
  fetchData()
    ...
    return(
        <section className="max-w-7xl mx-auto py-5 px-6 md:px-10 md:py-24" data-testid="tabbed-featured">
